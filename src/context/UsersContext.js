...
const UsersContextProvider = ({children}) => {
    ...
    async function loginUser(userInfo) {
        ...
        const res= await axios.post("https://budget-planner-api2.herokuapp.com/api/v1/users/login",
        userInfo, config
        );
  ...
  async function logout() {
    ...
    async function registerUser(newuser){
      ...
      const {data}=await axios.post("https://budget-planner-api2.herokuapp.com/api/v1/users/register",
    newuser,
    config
      );
